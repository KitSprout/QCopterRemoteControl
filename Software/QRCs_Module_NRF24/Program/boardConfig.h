...
#define NRF24_SPIx_CLK_ENABLE()       __HAL_RCC_SPI3_CLK_ENABLE()
#define NRF24_SPIx_IRQn               SPI3_IRQn
#define NRF24_SPIx_IRQn_PREEMPT       0x0F
#define NRF24_SPIx_IRQn_SUB           1
#define NRF24_SPIx_FORCE_RESET()      __HAL_RCC_SPI3_FORCE_RESET()
#define NRF24_SPIx_RELEASE_RESET()    __HAL_RCC_SPI3_RELEASE_RESET()
#define NRF24_SPIx_SPEED              SPI_BAUDRATEPRESCALER_4

#define NRF24_SCK_PIN                 GPIO_PIN_3
#define NRF24_SCK_GPIO_PORT           GPIOB
#define NRF24_SCK_AF                  GPIO_AF6_SPI3

#define NRF24_SDO_PIN                 GPIO_PIN_4
#define NRF24_SDO_GPIO_PORT           GPIOB
#define NRF24_SDO_AF                  GPIO_AF6_SPI3

#define NRF24_SDI_PIN                 GPIO_PIN_5
#define NRF24_SDI_GPIO_PORT           GPIOB
#define NRF24_SDI_AF                  GPIO_AF6_SPI3
...
#define NRF24_IRQ_EXTIx_IRQ           EXTI9_5_IRQn
